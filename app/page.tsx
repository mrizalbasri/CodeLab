...
import { Box, Button, Card, Container, Flex, Grid, Heading, Section, Text, Badge } from "@radix-ui/themes";
import { ArrowRight, Code, Terminal, Cpu, Globe, Zap, Users, Trophy, HandHeart, Calendar } from "lucide-react";
...
const CodeBlock = () => {
  ...
  return (
    <Box p="4" style={{ fontFamily: "monospace", fontSize: "14px", lineHeight: "1.6" }}>
      {lines.map((line, i) => (
        <motion.div
          key={i}
        ...
        >
          <div style={{ paddingLeft: line.indent * 8 }}>
            <Text color={line.color as any} style={{ fontFamily: 'monospace' }}>{line.text}</Text>
          </div>
        </motion.div>
      ))}
      {visibleLines >= lines.length && (
        ...
        >
          <Text color="green" style={{ fontFamily: 'monospace' }}>// Code your future...</Text>
      ...
      >
        ...
        <Container size="3" style={{ position: 'relative', zIndex: 1 }}>
          <Flex direction="column" align="center" gap="6">
            ...
            >
              <Badge size="3" variant="surface" color="indigo" radius="full" style={{
            ...
            >
              <Heading size="9" align="center" style={{ fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1.1 }}>
                <Text style={{ background: "linear-gradient(to right, var(--indigo-9), var(--plum-9))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                  PU PEKANBARU CODE LAB
                </Text>
              </Heading>
              <Heading size="9" align="center" style={{ fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1.1, marginTop: "-10px" }}>
                (PUPCL)
              </Heading>
            </motion.div>
            ...
            >
              <Text size="5" align="center" color="gray" style={{ maxWidth: 600, lineHeight: 1.6, marginTop: '20px' }}>
            ...
            >
              <Flex gap="4" mt="6" mb="8">
                <Link href="/about">
                  <Button size="4" variant="solid" highContrast style={{ cursor: 'pointer', borderRadius: "12px" }}>
                    Explore Events <ArrowRight size={18} />
                  </Button>
                </Link>
                <Link href="/contact">
                  <Button size="4" variant="outline" color="gray" style={{ cursor: 'pointer', borderRadius: "12px", background: "white" }}>
                    Learn More
                  </Button>
                </Link>
              </Flex>
            ...
            >
              ...
              >
                {/* Window Controls */}
                <Flex gap="2" p="3" style={{ borderBottom: "1px solid var(--gray-4)", background: "var(--gray-3)" }}>
      ...
      <Box style={{ backgroundColor: "var(--gray-1)" }} py="9">
        <Container size="4">
          <Grid columns={{ initial: "1", md: "3" }} gap="6">
            ...
            <motion.div whileHover={{ translateY: -5 }} transition={{ delay: 0.1 }}>
              <Card style={{ backgroundColor: "var(--gray-2)", border: "none" }}>
                <Flex align="center" gap="4" p="2">
            ...
            <motion.div whileHover={{ translateY: -5 }} transition={{ delay: 0.2 }}>
              <Card style={{ backgroundColor: "var(--gray-2)", border: "none" }}>
                <Flex align="center" gap="4" p="2">
      ...
      <Section size="3">
        <Container size="4">
          <Flex direction="column" align="center" mb="9" gap="4">
            <Heading size="8" align="center" weight="bold">Why Join PUPCL?</Heading>
          ...
          <Grid columns={{ initial: "1", sm: "2", md: "3" }} gap="6">
            {[
              ...
              { icon: Zap, color: "yellow", title: "Job Connect", desc: "Exclusive internship opportunities." },
              { icon: Globe, color: "blue", title: "Real Projects", desc: "Build apps for real clients." },
              { icon: Terminal, color: "green", title: "Hackathons", desc: "Compete and win cash prizes." },
            ].map((feature, i) => (
